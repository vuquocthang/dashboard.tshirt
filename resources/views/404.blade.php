...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets') }}/app-assets/css/pages/error.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
                      ...
                      <button class="btn btn-lg btn-secondary border-grey border-lighten-1" type="button"><i class="ft-search"></i></button>
                                ...
                                <div class="row py-2">
                                    <div class="col-12 col-sm-6 col-md-6">
                                        <a href="{{ route('home') }}" class="btn btn-primary btn-block"><i class="ft-home"></i> Trở Về Trang Chủ</a>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-6">
                                        <a href="#" class="btn btn-danger btn-block"><i class="ft-search"></i>  Tìm Kiếm</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer bg-transparent">
                                <div class="row">
                                    <p class="text-muted text-center col-12 py-1">© 2018 King Clothes , All rights reserved.</p>
