                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-outline-success round" onclick="window.location.href='{{ route('user.order.detail', $order->id) }}'">{{ $order->currentStatus() }}</button>
                                                </td>
                                            </tr>
											@endforeach
										</tbody>
