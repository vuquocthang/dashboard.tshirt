            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="dropdown float-md-right">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownBreadcrumbButton">
                        <a class="dropdown-item" href="{{ route('admin.order.status', [$order->id, 0]) }}">{!! $order->currentStatusCode() == 0 ? "<i class='ft-check'></i>" : "" !!} Chưa Thanh Toán</a>
                        <a class="dropdown-item" href="{{ route('admin.order.status', [$order->id, 1]) }}">{!! $order->currentStatusCode() == 1 ? "<i class='ft-check'></i>" : "" !!} Đã Thanh Toán</a>
                        <a class="dropdown-item" href="{{ route('admin.order.status', [$order->id, 2]) }}">{!! $order->currentStatusCode() == 2 ? "<i class='ft-check'></i>" : "" !!} Đã Chuyển Hàng</a>
                        <a class="dropdown-item" href="{{ route('admin.order.status', [$order->id, 3]) }}">{!! $order->currentStatusCode() == 3 ? "<i class='ft-check'></i>" : "" !!} Hoàn Thành</a>
                    </div>
                </div>
            </div>
        </div>
